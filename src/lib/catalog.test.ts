...
import { availabilityLabel, formatCents, parseCatalog, toCents } from "./catalog.ts";

const item = { id: "chips", name: "Cookie Chips", description: null, price: "5000.00", stock: 4, imageUrl: "/images/cookies/a.jpg", category: "Cookies", featured: true };
